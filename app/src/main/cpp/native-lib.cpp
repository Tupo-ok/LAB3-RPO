...
char *personalization = "LABRPO-sample-app";
JavaVM* gJvm = nullptr;
...
extern "C" JNIEXPORT jbyteArray JNICALL
Java_com_example_myapplication_MainActivity_encrypt(JNIEnv *env, jclass, jbyteArray key, jbyteArray data)
{
...
extern "C" JNIEXPORT jbyteArray JNICALL
Java_com_example_myapplication_MainActivity_decrypt(JNIEnv *env, jclass, jbyteArray key, jbyteArray data)
{
    jsize ksz = env->GetArrayLength(key);
    jsize dsz = env->GetArrayLength(data);
